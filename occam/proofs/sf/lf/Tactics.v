...
Proof.
  ...
  - destruct m.
    + intro H. discriminate H.
    + intro H. simpl in H.  apply IHn in H. 
...
Proof.
  ...
  + generalize dependent m.
    ...
    - destruct m.
      * reflexivity.
      * intros E. simpl in E. apply IHn in E. simpl. apply E.
Qed.
(** [] *)
...
Proof.
  intros.
  apply eqb_true in H. apply eqb_true in H0.
...
Proof.
  ...
  - induction (x' :: l).
    ...
    + simpl. destruct (test x0) eqn:T.
      * intro H. injection H as H. rewrite H in T. apply T.
      * apply IHl0.
Qed.
(** [] *)
